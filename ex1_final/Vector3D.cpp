...
{
    double d1 = other._vector[0];
    double d2 = other._vector[1];
    double d3 = other._vector[2];
    _init(d1, d2, d3);
}
...
{
    return outStream << other._vector[0] << " " << other._vector[1] << " " << other._vector[2];
}
...
{
    inStream >> vector._vector[0];
    inStream >> vector._vector[1];
    inStream >> vector._vector[2];
    return inStream;
}
...
{
    return Vector3D(this->_vector[0] + other._vector[0], this->_vector[1] + other._vector[1],
            this->_vector[2] + other._vector[2]);
}
...
{
    return Vector3D(other._vector[0] * num, other._vector[1] * num, other._vector[2] * num);
}
...
{
    double d1 = pow(this->_vector[0] - other._vector[0], 2);
    double d2 = pow(this->_vector[1] - other._vector[1], 2);
    double d3 = pow(this->_vector[2] - other._vector[2], 2);
    double sum = d1 + d2 + d3;
    return sqrt(sum);
}
 ...
 */
const double Vector3D::operator*(Vector3D &other) const
{
    double d1 = this->_vector[0] * other._vector[0];
    double d2 = this->_vector[1] * other._vector[1];
    double d3 = this->_vector[2] * other._vector[2];
    return d1 + d2 + d3;
}
