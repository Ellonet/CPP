...
public:
     ...
     * @return - a new matrix.
     */
    const Matrix3D operator+(Matrix3D &other) const;
     ...
     * @return a new vector
     */
    const Vector3D operator*(Vector3D &vector) const;
     ...
     */
    const Vector3D row(int index) const;
     ...
     * @return a Vector3D vector
     */
    const Vector3D column(int index) const;
