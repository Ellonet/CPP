...
{
    _init(other._v1, other._v2, other._v3);
}
...
{
    return outStream << matrix._v1 << endl << matrix._v2 << endl << matrix._v3;
}
...
Matrix3D &Matrix3D::operator*=(Matrix3D &other)
{
    ...
    row2 = other.row(1);
    row3 = other.row(2);
    this->_v1[0] = row1 * col1;
    this->_v1[1] = row1 * col2;
    this->_v1[2] = row1 * col3;
    this->_v2[0] = row2 * col1;
    this->_v2[1] = row2 * col2;
    this->_v2[2] = row2 * col3;
    this->_v3[0] = row3 * col1;
    this->_v3[1] = row3 * col2;
    this->_v3[2] = row3 * col3;
    return *this;
}
 ...
 * @return - a new matrix.
 */
const Matrix3D Matrix3D::operator+(Matrix3D &other) const
{
    return Matrix3D(this->_v1 + other._v1, this->_v2 + other._v2, this->_v3 + other._v3);
}
 ...
 * @return a new vector
 */
const Vector3D Matrix3D::operator*(Vector3D &vector) const
{
    return Vector3D(this->_v1 * vector, this->_v2 * vector, this->_v3 * vector);
}
 ...
 */
const Vector3D Matrix3D::row(int index) const
{
    Vector3D res;
    if (index == 0)
    {
 ...
 * @return a Vector3D vector
 */
const Vector3D Matrix3D::column(int index) const
{
    Vector3D res;
    if (index == 0)
    {
        res = Vector3D(this->_v1[0], this->_v2[0], this->_v3[0]);
    }
    else if (index == 1)
    {
        res = Vector3D(this->_v1[1], this->_v2[1], this->_v3[1]);
    }
    else if (index == 2)
    {
        res = Vector3D(this->_v1[2], this->_v2[2], this->_v3[2]);
    }
    else
    {
        cerr << "Error - out of range";
...
{
    return this->_v1[0] + this->_v2[1] + this->_v3[2];
}
